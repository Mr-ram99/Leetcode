...
class Solution{
    ...
    // public static void countMax(int [] arr, ArrayList<Integer> list, ArrayList<Integer> li, int ind, long product, long[] max, int c){
    //     if(c==3){
    //         if(product>max[0]){
    ...
    //         if(arr[i]>arr[ind]){
    //             countMax(arr,list,li,i,product,max,c+1);
    //         }
    //     }
    //     li.remove(li.size()-1);
    // }
